...
values (1001,'_OceanofPDF.com_Improve_Your_People_Skills_-_Patrick_King.pdf','1738772447203__OceanofPDF.com_Improve_Your_People_Skills_-_Patrick_King.pdf');

  insert into document_details(id,file_name,file_identifier)
  values (1002,'_OceanofPDF.com_Improve_Your_People_Skills_-_Patrick_King.pdf','1738772447203__OceanofPDF.com_Improve_Your_People_Skills_-_Patrick_King.pdf');

  insert into document_details(id,file_name,file_identifier)
  values (1003,'_OceanofPDF.com_Improve_Your_People_Skills_-_Patrick_King.pdf','1738772447203__OceanofPDF.com_Improve_Your_People_Skills_-_Patrick_King.pdf');

-- 1738772447203__OceanofPDF.com_Improve_Your_People_Skills_-_Patrick_King.pdf 

 insert into document_details(id,file_name,file_identifier)
values (1004,'_OceanofPDF.com_Improve_Your_People_Skills_-_Patrick_King.pdf','1738772447203__OceanofPDF.com_Improve_Your_People_Skills_-_Patrick_King.pdf');
...
-- -- ACCREDITATION_DETAILS
 ...
 insert into document_details(id,file_name,file_identifier)
values (2001,'nep_1.txt','nep_1.txt');
insert into document_details(id,file_name,file_identifier)
values (2002,'nep_2.txt','nep_2.txt');
insert into document_details(id,file_name,file_identifier)
values (2003,'nep_3.txt','nep_3.txt');
insert into document_details(id,file_name,file_identifier)
values (2004,'nep_4.txt','nep_4.txt');
insert into document_details(id,file_name,file_identifier)
values (2005,'nep_5.txt','nep_5.txt');
insert into document_details(id,file_name,file_identifier)
values (2006,'nep_6.txt','nep_6.txt');

insert into document_details(id,file_name,file_identifier)
values (2011,'el1.txt','el1.txt');
insert into document_details(id,file_name,file_identifier)
values (2012,'el2.txt','el2.txt');
insert into document_details(id,file_name,file_identifier)
values (2013,'el3.txt','el3.txt');
insert into document_details(id,file_name,file_identifier)
values (2014,'el4.txt','el4.txt');
insert into document_details(id,file_name,file_identifier)
values (2015,'el5.txt','el5.txt');

insert into nep_details (id,document_id,section,university_id)
values (1,2001,0,1);
insert into nep_details (id,document_id,section,university_id)
values (2,2002,1,1);
insert into nep_details (id,document_id,section,university_id)
...
insert into electoral_literacy_details (id,document_id,section,university_id)
values (1,2011,0,1);
